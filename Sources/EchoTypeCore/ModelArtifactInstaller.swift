...
public final class ModelArtifactInstaller: @unchecked Sendable {
    ...
    public func install(
        ...
        do {
            ...
            try markerData.write(to: stagingURL.appendingPathComponent(".echotype-installed.json"), options: .atomic)
            try Task.checkCancellation()
    ...
    public func isInstalled(_ download: ModelDownload) -> Bool {
        ...
        let markerURL = installationURL.appendingPathComponent(".echotype-installed.json")

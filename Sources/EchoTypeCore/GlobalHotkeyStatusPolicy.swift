...
public enum GlobalHotkeyStatusPolicy {
    ...
    public static func message(
        ...
        guard globalMonitorInstalled else {
            return "The system-wide keyboard listener did not start. Choose Enable Hotkey to retry; if registration keeps failing, restart EchoType and check its Accessibility permission."
        }

...
private let echoTypeHotKeySignature: OSType = 0x4543_5459 // "ECTY"

/// Registers key chords as system hotkeys. macOS delivers a registered chord only to EchoType,
...
final class SystemHotKeyCenter {
    ...
    func register(
        ...
        let status = RegisterEventHotKey(
            ...
            modifiers,
            EventHotKeyID(signature: echoTypeHotKeySignature, id: id),
...
private func echoTypeHotKeyEventHandler(
    ...
    guard status == noErr, hotKeyID.signature == echoTypeHotKeySignature else {
